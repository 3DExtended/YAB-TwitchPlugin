...
{
    [ClassDescription("Use this reactor to update pipelines created with the AddPredefinedTwitchMessagePipelineReactorConfiguration. Use it like this: \"!editcom {commandName} {response}\"")]
